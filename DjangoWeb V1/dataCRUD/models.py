...
class mergedTables(models.Model):
    ...
    ENT_LAT         =models.FloatField()
    ENT_LON         =models.FloatField()
    ADR_LAT         =models.FloatField()
    ADR_LON         =models.FloatField()
    SITE_LAT        =models.FloatField()
    SITE_LON        =models.FloatField()    
    home_campus     =models.FloatField()
    home_entreprise =models.FloatField()
    campus_entreprise =models.FloatField()
    idCSV           =models.IntegerField(blank=True,null=True)
